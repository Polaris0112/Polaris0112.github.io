---
title: 比特币区块结构 Merkle 树及简单支付验证分析
date: 2018-03-03
categories: 比特币区块结构 Merkle 树及简单支付验证分析
tags:
- Blockchain

---
本帖子记录的是比特币区块结构 Merkle 树及简单支付验证分析
...
在[工作量证明](https://polaris0112.github.io/2018/03/03/blockchain-pow/)中出现过一个区块信息截图：
...
![blockchain-9](/images/blockchain-9.jpg)
...
上面先留一个引子，先来回顾下哈希函数，[记账原理](https://polaris0112.github.io/2018/03/02/blockchain-accounting/)我们知道原始信息任何微小的变化都会哈希完全不同的哈希值。
...
![blockchain-10](/images/blockchain-10.jpg)
