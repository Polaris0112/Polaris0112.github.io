...
date: 2018-03-03
categories: 比特币如何挖矿（挖矿原理）-工作量证明
tags:
- Blockchain

---
本帖子记录的是比特币如何挖矿（挖矿原理）-工作量证明


在[区块链记账原理](https://polaris0112.github.io/2018/03/02/blockchain-accounting/)一篇，我们了解到记账是把交易记录、交易时间、账本序号、上一个Hash值等信息计算Hash打包的过程。
...
[区块链记账原理](https://polaris0112.github.io/2018/03/02/blockchain-accounting/)我们了解到，每次记账的时候会把上一个块的Hash值和当前的账页信息一起作为原始信息进行Hash。
...
![blockchain-6](/images/blockchain-6.jpg)


注：[数据来源](https://blockchain.info)
...
进阶阅读[比特币区块结构Merkle树及简单支付验证分析](https://polaris0112.github.io/2018/03/03/blockchain-merkle/)，可以详细了解区块结构如何验证交易。
...
本文中有提到共识协议，比特币共识协议主要是由工作量证明和最长链机制 两部分组成，请阅读[比特币如何达成共识 - 最长链的选择](https://polaris0112.github.io/2018/03/03/blockchain-selection/)。
