---
title: MyISAM和InnoDB区别详解
date: 2018-02-26
categories: MySQL存储引擎中的MyISAM和InnoDB区别详解
tags: 
- MySQL
- MyISAM
- InnoDB
...
---
本帖子记录的是MySQL存储引擎中的MyISAM和InnoDB区别详解

## 知识背景

在使用MySQL的过程中对MyISAM和InnoDB这两个概念存在了些疑问，到底两者引擎有何分别一直是存在我心中的疑问。
